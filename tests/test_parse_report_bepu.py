...
class ParseReportBEPUTest(TestCase):
    def setUp(self):
        ...
        self.report_csv = [
            ...
            ["REPORT", "BEPU Building Utility Performance", "WEATHER FILE",
             "CHICAGO, IL"],
            ["METER", "TYPE", "UNIT", "LIGHTS", "TASK\nLIGHTS", "MISC\nEQUIP",
             "SPACE\nHEATING", "SPACE\nCOOLING", "HEAT\nREJECT", "PUMPS\n& AUX",
             "VENT\nFANS", "REFRIG\nDISPLAY", "HT PUMP\nSUPPLEN",
             "DOMEST\nHOT WTR", "EXT\nUSAGE", "TOTAL"],
            ['EM1', 'ELECTRICITY', 'KWH', '69156.', '0.', '92425.', '0.',
             '25606.', '0.', '2116.', '22465.', '0.', '0.', '0.', '0.',
             '211768.'],
            ['FM1', 'NATURAL-GAS', 'THERM', '0.', '0.', '0.', '3417.', '0.',
             '0.', '0.', '0.', '0.', '0.', '410.', '0.', '3827.'],
